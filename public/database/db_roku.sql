...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 17, 2021 at 03:09 AM
...
(1, 'I Love Lucy', '1951', '8.4', 'William Asher, Marc Daniels\r\n', 'Lucille Ball, Desi Arnaz, Vivian Vance', '', 'Naive and ambitious but lacking the skill, Lucy\'s relentless efforts to get into showbiz often lands herself and her husband into trouble.Her neighbours and friends also get entangled in her antics.', 'Comedy, Family', 'TV-G', '30m', 'lucy_thumbnail.jpg', 'https://www.youtube.com/embed/gO7HicngsLw', 'parents', 'lucy_cover.jpg'),
(2, 'The Huckleberry Hound Show', '1951', '6.6', 'William Hanna, Joseph Barbera\r\n\r\n', 'Daws Butler, Don Messick, Doug Young', '', 'The adventures of a blue dog with a southern accent.', 'Animation, Comedy, Family', 'TV-G', '30m', 'hound_thumbnail.jpg', 'https://www.youtube.com/embed/jjGD1nFdhgU', 'kids', 'hound_cover.jpg'),
(3, 'Star Trek: The Original Series', '1966', '8.3', 'Gene Roddenberry', 'William Shatner, Leonard Nimoy, DeForest Kelley', '', 'James T Kirk, who is the captain of the Starship Enterprise, explores the whole galaxy with his crew and goes on several adventures as they fight evil forces together.', 'Action, Adventure, Sci-Fi', 'TV-PG', '50m', 'trek_thumbnail.jpg', 'https://www.youtube.com/embed/nPDb5wX4H7I', 'parents', 'trek_cover.jpg'),
(4, 'Scooby Doo, Where Are You!', '1969', '7.9', 'Joe Ruby, Ken Spears, Joseph Barbera', 'Don Messick, Casey Kasem, Nicole Jaffe', '', 'Brainiac Velma, jock Fred, fashionista Daphne, hippie Shaggy, and Shaggy\'s highstrung, talking Great Dane, Scooby-Doo, climb into their green van, the Mystery Machine, and hit the road in search of weird phenomena to solve. And even when Scooby and the gang aren\'t actively searching for them, mysteries just have a way of falling into their laps. Ruh-roh!', 'Animation, Adventure, Comedy ', '7.9', '22m', 'scooby_thumbnail.jpg', 'https://www.youtube.com/embed/7s_Pi1GWqMM', 'kids', 'scooby_cover.jpg'),
(5, 'Welcome Back, Kotter', '1975', '7.0', 'Gabe Kaplan, Alan Sacks, Peter Meyerson', 'Gabe Kaplan, Ron Palillo, John Travolta', '', 'Gabe Kotter returns to his old high school this time as a teacher. He\'s put in charge of a class full of unruly remedial students called the Sweathogs. They\'re a bunch of wisecracking, underachieving and incorrigible students, and it takes all of Mr. Kotter\'s humor and experience as a former Sweathog himself to deal with his class.', 'Comedy', 'TV-PG', '30m', 'kotter_thumbnail.jpg', 'https://www.youtube.com/embed/a3_QlasXQWY', 'parents', 'kotter_cover.jpg'),
(6, 'The Muppet Show ', '1976', '8.4', 'Jim Henson, Jack Burns', 'Jim Henson, Frank Oz, Richard Hunt', '', 'A fantastic medley of sweet and mischievous, Jim Henson\'s Muppets, including Kermit the Frog and Miss Piggy, produce a weekly variety show with a range of famous guests. Along for the ride are Gonzo, Fozzie the bear and Scooter - who is the closest thing to a human puppet this series has.', 'Comedy, Family, Music', 'TV-G', '30m', 'muppet_thumbnail.jpg', 'https://www.youtube.com/embed/NBE0O0SR7wY', 'kids', 'muppet_cover.jpg'),
(7, 'The Joy of Painting', '1983', '9.4', 'Bob Ross', 'Bob Ross, Steve Ross, Dana Jester', '', 'American painter Bob Ross offers soothing words of encouragement to viewers and painting hobbyists in an enormously popular series that has captivated audiences worldwide.', 'Documentary, Family', 'TV-G', '30m', 'painting_thumbnail.jpg', 'https://www.youtube.com/embed/gqdzXNsL_2o', 'parents', 'painting_cover.jpg'),
(8, 'Thundarr the Barbarian', '1980', '7.5', 'Steve Gerber', 'Henry Corden, Robert Ridgely, Nellie Bellflower', '', 'Thundarr the Barbarian and his companions Ookla the Mok and Princess Ariel wander a devastated future Earth and fight evil wherever they find it.', 'Animation, Adventure, Family', 'TV-Y7 ', '30m', 'thundarr_thumbnail.jpg', 'https://www.youtube.com/embed/4I9blXQEHyw', 'kids', 'thundarr_cover.jpg'),
(9, 'Friends', '1994', '8.9', 'David Crane, Marta Kauffman', 'Jennifer Aniston, Courteney Cox, Lisa Kudrow, Matt LeBlanc, Matthew Perry, David Schwimmer', '', 'Follow the lives of six reckless adults living in Manhattan, as they indulge in adventures which make their lives both troublesome and happening.', 'Comedy, Romance', 'TV-PG', '22m', 'friends_thumbnail.jpg', 'https://www.youtube.com/embed/ggZkZK-9Pm4', 'parents', 'friends_cover.jpg'),
(10, 'Johnny Bravo', '1997', '7.2', 'Van Partible, Jed Spingarn, Butch Hartman', 'Jeff Bennett, Brenda Vaccaro, Mae Whitman', '', 'Johnny Bravo has no shortage of confidence, and he\'s certain that all women want him. With his big hair and tight black clothes, he\'s known for his karate chops, accompanied by the sound of a bullwhip.', 'Animation, Adventure, Comedy', 'TV-Y7', '30m', 'johnny_thumbnail.jpg', 'https://www.youtube.com/embed/WhtpBCeOvEo', 'kids', 'johnny_cover.jpg');
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `parents_img` varchar(80) DEFAULT NULL,
...
(1, 'evanchan', 'evanchan', 'Parent Evan', 'Baby Jihee', 'evan.png', 'jihee.png'),
(2, 'test', 'password', 'Parent', 'Kids', NULL, NULL);
COMMIT;
